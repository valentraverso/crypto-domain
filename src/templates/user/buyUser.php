...
<div class="max-w-2xl mx-auto">
  <p class="ml-4 block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">How much do you want to buy?</p>
  <form class="m-4 flex">
...
<!-- resumen -->
    <div class="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
      ...
      <div class="mt-6 mb-6 rounded-lg border bg-white p-6 shadow-md md:w-1/2grid justify-items-center">
        ...
        <button class="mt-6 w-full rounded-md bg-purple py-1.5 font-medium text-blue-50 hover:bg-maroon">Buy it</button>
      </div>
    </div>
  </div>
<?php
